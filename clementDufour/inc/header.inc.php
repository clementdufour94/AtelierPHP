  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
    <a class="navbar-brand js-scroll-trigger" href="#page-top">
      <span class="d-none d-lg-block">
        ...
        <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="<?php $result2 = $pdo->query("SELECT * FROM profile");
          while($profile = $result2->fetch(PDO::FETCH_OBJ)) {
        
            echo $profile->url ;} ?>" alt="">
      </span>
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link js-scroll-trigger" href="connexion.php">Connection</a>
        </li>
